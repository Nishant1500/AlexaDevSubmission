<footer
	class="bg-gradient-to-br from-gray-100 via-gray-100 to-blue-500 px-4 pt-16 pb-8 md:px-8 dark:from-black dark:via-black"
>
	<div class="mx-auto max-w-7xl">
		<div class="grid gap-12 min-[1200px]:grid-cols-3 xl:gap-16">
			<div class="w-full max-w-lg min-[1200px]:max-w-sm">
				<ul class="mt-6 flex flex-wrap gap-6">
					<li>
						<a
							href="https://www.alexadevsrm.com/"
							class="flex h-8 w-8 items-center rounded-full bg-neutral-900 p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
							aria-label="Alexa Developers SRM"
						>
							<div
								class="h-6 w-6 bg-white"
								style="mask: url('https://www.alexadevsrm.com/recruitments26/Vector.svg') no-repeat center / contain; -webkit-mask: url('https://www.alexadevsrm.com/recruitments26/Vector.svg') no-repeat center / contain;"
							></div>
						</a>
					</li>
					<li>
					...
					<li class="text-sm text-slate-500 dark:text-slate-400">
						...
						<span
							>All assets, trademarks belong to their respective owners.
							<a
								href="https://www.alexadevsrm.com"
								class="text-blue-400 hover:underline"
								target="_blank">Alexa Developers SRM</a
							>
						</span>
					</li>
				</ul>
